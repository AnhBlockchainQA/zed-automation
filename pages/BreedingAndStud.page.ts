...
class BreedingAndStud {
  ...
  objects = {
    ...
    btnCloseModalBreedingDecay: `//div[@role='dialog']//button[contains(text(),'Close')]`,
    ...
    lblAddHorseStudFarm : '//div[text()="Add a Racehorse to Stud Farm"]',
    btnSelectHorse: '//button[text()="Select Racehorse"]',
    ...
    studList:{
      ...
      offspringValue: (id: number) =>`(//div[@class='offspring-info']//div)[${id}]`,
    ...
    filtersPanel: {
      ...
      breedGenesisLabel: 'label[for=\'genesis\']',
