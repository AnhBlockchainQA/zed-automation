const racingConfig = require("./Racing");
const {EVENT_LIST_SIZE} = require("./env");
const stringUtils = require("./utils/api/stringUtils");
const {REGEX} = require("./env");
const {ADD_RACE_CONFIRM_BUTTON} = require("./Payment");
const { RACING_EVENT_INFO, CUSTOM_CLASS_BUTTON, OPEN_GATE_LIST} = require("./Racing");
const { MetamaskFactory } = require("./utils/browser/metamaskFactory");
var confirmMetamaskNotificationInstance;
var metamaskFactory = new MetamaskFactory();
const { ACCEPT_BUTTON } = require("./ZedRun");
