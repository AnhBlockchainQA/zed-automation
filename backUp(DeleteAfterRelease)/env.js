module.exports = {
    ...
    SEED_PHRASE_2:
        "frame timber square minimum climb tackle jealous narrow say lamp tennis embrace",
    PASSWORD: "12345678",
    ...
    ACCOUNT_LIST: {
        ...
        SIXTH_ACCOUNT: {
            EMAIL: "zedrun6@1secmail.org",
            LOGIN: "zedrun6",
            DOMAIN: "1secmail.org"
        },
        SEVENTH_ACCOUNT: {
            EMAIL: "zedrun7@1secmail.org",
            LOGIN: "zedrun7",
            DOMAIN: "1secmail.org"
        }
    },
    ...
    INVALID_CODE: {
        CODE: "INVALID_COUPON",
        ERROR: "Invalid Coupon. Check Your Code And Try Again",
    },
    HORSE_LIST_SIZE: 5,
    EVENT_LIST_SIZE: 10,
    REGEX: {
