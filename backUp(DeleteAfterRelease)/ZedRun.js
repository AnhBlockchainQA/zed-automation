module.exports = {
    ...
    CONNECT_METAMASK: "#login-modal .login-options .metamask-login",
    ...
    RACING_LINK: "//div[@class='header-desktop']//div[@class='left-part']/div[@fixtures-tour='header-racing']//a[descendant::text()='racing']",
