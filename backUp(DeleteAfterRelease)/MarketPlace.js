module.exports = {
    ...
    // FIRST_HORSE_PREVIEW: ".ifs > .row > .horse-sale-card:nth-child(1) > .preview > .preview-horse > div > .horse-pose",
    ...
    HORSE_PRICE: ".ifs > .row > .horse-sale-card:nth-child(8) > .details > .price",
    HORSE_NAME: ".ifs > .row > .horse-sale-card:nth-child(8) > .details > .name",
    ...
    BUY_HORSE_BUTTON : ".ifs > .row > .horse-sale-card:nth-child(8) > .actions > .primary-btn"
};    